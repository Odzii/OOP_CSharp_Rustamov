...
namespace Model
{
    ...
    /// </summary>
    /// <remarks>
    /// Параллелепипед — это пространственная фигура, у которой противоположные грани попарно равны и параллельны.
    /// В данной реализации рассматривается прямоугольный параллелепипед, у которого все грани являются прямоугольниками.
    ...
    public class Parallelepiped : VolumeFigureBase
    {
        ...
        /// <summary>
        /// Возвращает строковое описание параллелепипеда с указанием его размеров.
        /// </summary>
